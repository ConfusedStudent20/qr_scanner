...
class _ScannerScreenState extends State<QRCodeGenerator> {
  ...
  Widget build(BuildContext context) {
    ...
    // final qrGenerator = Provider.of<QRScannerProvider>(context, listen: true);
    return Scaffold(
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Consumer<QRScannerProvider>(
                builder: (BuildContext context, qrGenerator, child) {
              return Column(
                mainAxisSize: MainAxisSize.min,
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  if (qrGenerator.qrCode.isNotEmpty)
                    Card(
                      elevation: 3.0,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      qrGenerator.generateQRCode(qrController.text);
                    },
                    child: const Text(
                      'Generate',
                      style: TextStyle(
